    ...
    <div class="lot-item__content">
      <div class="lot-item__left">
        <div class="lot-item__image">
          <img src="<?=esc($lot['img']); ?>" width="730" height="548" alt="<?=esc($lot['lot_name']); ?>">
        </div>
        <p class="lot-item__category">Категория: <span><?=esc($lot['cat_name']); ?></span></p>
        <p class="lot-item__description"><?=esc($lot['lot_descr']); ?></p>
      </div>
      <div class="lot-item__right">
        <div class="lot-item__state">
          <div class="lot-item__timer timer <?php if (lotTime($lot['date_end']) <= 60):?>timer--finishing<?php endif; ?>">
